    ...
    >
      ...
      <a-form :form="form" @submit="handleSubmit">
        ...
        <a-form-item label="教师类型" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select
            style="width:80%;"
            placeholder="请选择教师类型，可多选"
            v-decorator="['typeId',{rules: [{required: true, message: '请选择教师类型，可多选！'}]}]"
            mode="multiple"
            :allowClear="true"
          >
            <a-select-option
...
<script>
import { addTeacher, findAllMechanism, findAllMechanismType } from '@/api/manage'
